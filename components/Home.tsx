...
function Home() {
  ...
  return (
    <section className="w-full flex flex-col items-center  ">
      <div className="max-w-5xl p-8 w-full flex justify-center items-center gap-4 flex-col">
        <div>
        ...
        <div className="flex flex-col gap-4 items-center">
          ...
          <Link className="text-xl bg-black text-white p-2 font-bold rounded-md" href='/app'>
            Continue
          </Link>
        </div>
      </div>
